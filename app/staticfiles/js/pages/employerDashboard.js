...
const companyBtn = document.getElementById("company-view-btn");
...
async function loadJobs() {
    try {
        ...
        document.querySelectorAll(".edit-job")
                .forEach(button => {
...
async function init() {
    ...
    if (myCompanies.length > 0) {
        companyBtn.classList.remove("d-none");
        companyBtn.href = `/companies/${myCompanies[0].id}/`;
